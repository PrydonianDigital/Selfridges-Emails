								...
								<xsl:when test="Status != 'X'">
									...
									<xsl:if test="DeliveryMethod != 'UKSTORE'">
										...
										<span>Delivery Address</span>
											...
											<xsl:if test="DeliveryAddress/DeliveryName !=''"><strong style="font-weight:bold; text-transform: capitalize;"><xsl:value-of select="DeliveryAddress/DeliveryName"/></strong><br /></xsl:if>
